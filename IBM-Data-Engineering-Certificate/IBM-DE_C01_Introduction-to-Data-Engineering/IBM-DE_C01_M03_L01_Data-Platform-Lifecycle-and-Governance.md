# L01 Data Platform Architecture, Data Wrangling, Querying, Performance Tuning, Security, and Governance
...
- **Joins** — combine _columns_ from two tables into one row
- **Unions** — combine _rows_ from two tables into one table
...
_An auditable trail is required at every stage._
